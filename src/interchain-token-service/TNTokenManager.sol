...
import { IERC20MintableBurnable } from '@axelar-network/interchain-token-service/contracts/interfaces/IERC20MintableBurnable.sol';

/// @notice TNTokenManager minimally extends TokenManager to accept return values for mints/burns made to the RWTEL module 
/// which handles decimal conversion between existing canonical TEL ERC20s on remote chains and Telcoin-Network's native 18 decmals
