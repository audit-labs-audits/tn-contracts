...
import { ITokenHandler } from '@axelar-network/interchain-token-service/contracts/interfaces/ITokenHandler.sol';
...
import { IERC20BurnableFrom } from '@axelar-network/interchain-token-service/contracts/interfaces/IERC20BurnableFrom.sol';
import { IMinter } from '@axelar-network/interchain-token-service/contracts/interfaces/IMinter.sol';

/// @dev Note: Unchanged from Axelar ITS v2.1.0 save for conditional branches for TEL decimal handling across chains using TNTokenManager
/// to accept mint/burn return values within TokenHandler's `giveToken` and `takeToken` fns, using `_mintTEL`, and `_burnTEL`
...
contract TokenHandler is ITokenHandler, ITokenManagerType, ReentrancyGuard, Create3AddressFixed {
    ...
    bytes32 telInterchainTokenId = 0xc34cbb885926317c1d606b677fc05fcf5207cc2acdc4af0b4cc61763b2069a58;
