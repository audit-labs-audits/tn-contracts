...
contract InterchainTokenServiceForkTest is Test, ITSTestHelper {
    ...
    //todo: move e2e tests to RWTELForkTest.t.sol
    ...
    function test_e2eDevnet_deployRemoteCanonicalInterchainToken() public {
        ...
        setUp_tnFork_devnetConfig_genesis(tnFork, deployments.admin, deployments.sepoliaTEL, deployments.wTEL);
