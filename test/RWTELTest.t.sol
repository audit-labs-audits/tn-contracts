...
contract RWTELTest is Test {
    ...
    function setUp() public {
        ...
        rwTEL = new RWTEL(address(0x0), address(tnGateway), name_, symbol_, recoverableWindow_, governanceAddress_, baseERC20_, maxToClean);
    ...
    function test_bridgeSimulation() public {
        ...
        bytes32 ethSignPrefixedMsg = keccak256(bytes.concat('\x19Ethereum Signed Message:\n96', domainSeparator, signersHash, dataHash));
        vm.prank(admin);
