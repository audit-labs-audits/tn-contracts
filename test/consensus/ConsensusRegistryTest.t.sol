...
contract ConsensusRegistryTest is ConsensusRegistryTestUtils {
    ...
    function test_activate() public {
        ...
        consensusRegistry.concludeEpoch(new address[](activeValidators.length), new Slash[](0));
        vm.stopPrank();
    ...
    function test_beginExit() public {
        ...
        vm.prank(sysAddress);
        consensusRegistry.concludeEpoch(new address[](numActiveBefore), new Slash[](0));
        ...
        vm.startPrank(sysAddress);
        consensusRegistry.concludeEpoch(new address[](4), new Slash[](0));
        consensusRegistry.concludeEpoch(new address[](4), new Slash[](0));
        vm.stopPrank();
