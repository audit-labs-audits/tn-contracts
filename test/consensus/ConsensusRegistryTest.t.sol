...
contract ConsensusRegistryTest is KeyTestUtils, Test {
    ...
    function setUp() public {
        ...
        for (uint256 i; i < records.length; ++i) {
            // grab all recorded state changes associated with `consensusRegistry`
            uint256 storageAccessesLen = records[i].storageAccesses.length;
            for (uint256 j; j < storageAccessesLen; ++j) {
                assertEq(records[i].storageAccesses[j].account, address(consensusRegistry));
                // todo convert to uint and write these to json
                console2.logBytes32(records[i].storageAccesses[j].slot);
                console2.logString("{");
                console2.logString("previous_or_original_value: ");
                console2.logBytes32(records[i].storageAccesses[j].previousValue);
                console2.logString("present_value: ");
                console2.logBytes32(records[i].storageAccesses[j].newValue);
                console2.logString("}");
            }
        }
        return;
        ...
        */
        ...
        // bytes memory alloySolCalldata = bytes(hex'');
