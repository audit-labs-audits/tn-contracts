 ...
 * @dev Usage example for verifying GMP msgs on an Axelar internal gateway:
 * @dev Usage example for verifying GMP messages on a target AxelarAmplifierGateway:
 *
 * `npm run verify -- \
...
export async function verify({
  ...
  console.log("Starting voting verifier validation process of GMP message");
